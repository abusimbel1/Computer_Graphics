...
public class Pencil implements ActionListener {
    ...
    private final float upperEyeLimit = 5.0f; // 5.0
    private final float lowerEyeLimit = 1.0f; // 1.0
    private final float farthestEyeLimit = 6.0f; // 6.0
    private final float nearestEyeLimit = 3.0f; // 3.0
